...
class UserADO implements EntityInterfaceADO {
  ...
  */
  public static function fromResultSet( $row ) {
    ...
    $surname1 = $row[ UserADO::$colNameSurname1 ];
    $nick = $row[ UserADO::$colNameNick ];
    $password = $row[ UserADO::$colNamePassword ];
    $address = $row[ UserADO::$colNameAddress ];
    $telephone = $row[ UserADO::$colNameTelephone ];
    $mail = $row[ UserADO::$colNameMail ];
    $birthDate = $row[ UserADO::$colNameBirthDate ];
    $entryDate = $row[ UserADO::$colNameEntryDate ];
    $dropOutDate = $row[ UserADO::$colNameDropOutDate ];
    $active = $row[ UserADO::$colNameActive ];
  ...
  */
  public function create($user) {
    ...
    $cons="insert into ".UserADO::$tableName." (`name`,`surname1`,`nick`,`password`,`address`,`telephone`,`mail`,`birthDate`,`entryDate`,`dropOutDate`,`active`,`image`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
