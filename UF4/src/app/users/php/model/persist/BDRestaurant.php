...
class DBConnect{
  ...
  private function connection(){
    try{
      ...
      echo "Hola";
      error_log("UserApp (DBRestaurant) - Error connecting to database: ".$e);
    }
  }
  ...
  public function execution($sql,$vector){
    if($this->link !=null){
      ...
      try
      {
        ...
        error_log("UserApp (DBRestaurant) - Error executing query: ".$e);
      }
    }else{
      $this->stmt=null;
    }
  ...
  public function executionInsert($sql,$vector){
    ...
    if($this->link !=null){
      ...
      try
      {
        ...
        error_log("UserApp (DBRestaurant) - Error executing insert: ".$e);
      }
    } else {
      $id=null;
    }
