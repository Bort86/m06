...
export class Reservation {
  ...
  constructor (id?:number,name?:string, surname?:string, email?:string,
    phone?:string, reservationDate?:any, reservationTime?:ReservationTime,
    tablePreference?:TablePreference, specialRequests?:SpecialRequest[],totalPrice?:number )  {
    this.setId(id);
    this.setName(name);
  ...
  calculateTotalPrice(): void{
    this.setTotalPrice(18);
    //this.totalPrice = 15; es lo mismo
