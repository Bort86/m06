...
export class Reservation {
  ...
  constructor (id?:number,name?:string, surname?:string, email?:string, phone?:string, reservationDate?:any,
    reservationTime?:ReservationTime, tablePreference?:TablePreference,
    specialRequests?:SpecialRequest[],totalPrice?:number )  {
    this.setId(id);
    this.setName(name);
  ...
  calculateTotalPrice(): void {
    ...
    for(let specialRequest of this.specialRequests) {
      this.totalPrice = this.totalPrice + specialRequest.price;
    }

    this.totalPrice = this.totalPrice + this.tablePreference.price;
  }
}
